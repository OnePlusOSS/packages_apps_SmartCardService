...
public class Channel {
    ...
    public byte[] getSelectResponse()
    {
		...
		/* + snb log */
		Log.v(CHANNEL_TAG, "getSelectResponse start");
		/* - snb log */
		...
		/* + snb log */
        Log.v(CHANNEL_TAG, "getSelectResponse end");
		/* - snb log */
    ...
    public boolean selectNext() throws IOException {
        ...
        synchronized( mLock ) {
			/* + snb log */
			Log.v(CHANNEL_TAG, "selectNext start");
			/* - snb log */
	        SmartcardError error = new SmartcardError();
	        try {
	        ...
	        SEService.checkForException(error);
			/* + snb log */
			Log.v(CHANNEL_TAG, "selectNext end");
			/* - snb log */
        }
        return response;
